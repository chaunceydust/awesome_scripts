...
## ----captioner, echo = FALSE, results = "hide"---------------------------
library(captioner)
...
## ----plot-merker-expression-distribution, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-merker-expression-distribution"))----
library(ggplot2)
library(reshape2)
...
## ----plot-number-of-cells, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-number-of-cells"))----
...
## ----plot-mds, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-mds"))----
...
## ----plot-dendogram, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-dendogram"))----
library(RColorBrewer)
library(pheatmap)
...
## ----nrs, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("nrs"))----
...
## ----plot-clustering-heatmap1, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap1"))----
...
## ----plot-clustering-distribution1, fig.height = 8, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-distribution1"))----
library(ggjoy)
...
## ----tsne-plot-one-expr-CD4, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-expr-CD4"))----
...
## ----tsne-plot-one-clustering1, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-clustering1"))----
...
## ----tsne-plot-facet-sample, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-facet-sample"))----
## Facet per sample
ggp + facet_wrap(~ sample_id) 

## ----tsne-plot-facet-condition, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-facet-condition"))----
## Facet per condition
...
## ----plot-som-codes1-pca, fig.height = 8, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-som-codes1-pca"))----
## Plot PCA on codes
...
## ----tsne-plot-one-clustering1m, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-clustering1m"))----
...
## ----plot-clustering-heatmap1m-merging, fig.height = 5, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap1m-merging"))----
plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
...
## ----plot-clustering-heatmap1m, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap1m"))----
plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
  expr01 = expr01[, lineage_markers_ord], cell_clustering = cell_clustering1m,
  color_clusters = color_clusters)

## ----consensus-plot, out.width = '80%', fig.align='center', fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("consensus-plot"))----
...
## ----tsne-plot-one-clustering2, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-clustering2"))----
...
## ----plot-clustering-heatmap2, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap2"))----
plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
...
## ----tsne-plot-one-clustering2m, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-clustering2m"))----
...
## ----plot-clustering-heatmap2-merging, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap2-merging"))----

plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
  expr01 = expr01[, lineage_markers_ord], cell_clustering = cell_clustering2,
  color_clusters = color_clusters, cluster_merging = cluster_merging2)

## ----plot-clustering-heatmap2m, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap2m"))----
plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
...
## ----tsne-plot-one-clustering3, fig.height = 8, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("tsne-plot-one-clustering3"))----
...
## ----plot-clustering-heatmap3, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("plot-clustering-heatmap3"))----
plot_clustering_heatmap_wrapper(expr = expr[, lineage_markers_ord],
...
## ----diff-freqs-plot-props-barplot, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-freqs-plot-props-barplot"))----
...
## ----diff-freqs-plot-props-boxplot, fig.height = 4, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-freqs-plot-props-boxplot"))----
...
## ----diff-freqs-plot-heatmap-with-significant-clusters, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-freqs-plot-heatmap-with-significant-clusters"))----
...
## ----diff-expr2-plot-median-expr, fig.height = 8, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-expr2-plot-median-expr"))----
...
## ----diff-expr2-plot-heatmap-with-significant-markers, fig.height = 10, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-expr2-plot-heatmap-with-significant-markers"))----
...
## ----diff-expr1-plot-median-expr, fig.height = 8, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-expr1-plot-median-expr"))----
...
## ----diff-expr1-plot-heatmap-with-significant-markers, fig.height = 3, fig.cap = gsub(ifelse(on.bioc, "", "Figure  [0-9]{1,2}: "), "", fig_nums("diff-expr1-plot-heatmap-with-significant-markers"))----
